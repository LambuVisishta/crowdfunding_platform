        ...
        >
          <div className={`row ${styles.allContent}`}>
            ...
            <div className={`col-7 ${styles.campaignContent}`}>
              <div className={styles.title} style={{ fontSize: "1.5rem", fontWeight: "bold" }}>
                <p>{props.title}</p>
              </div>
          ...
          <div className="row">
            <div className={styles.bottomSection}>
              <div className={`col-7 ${styles.contentBottomSection}`}>
                <div className="row">
                  <div className={`col-7 ${styles.requiredAmount}`} style={{ fontSize: "1.2rem" }}>
                    <b>Required Amount:</b>
                    <p>
                  ...
                  <div className={`col-5  ${styles.DonateNow}`}>
                    <p className={styles.DonateNow_p} style={{ fontSize: "1.2rem", fontWeight: "bold" }}>
                      Donate Now{" "}
